...
let ImportsScanner = class ImportsScanner {
    buildSourceFileImportsMap(sourceFile, project) {
        ...
        for (const importDeclaration of importDeclarations) {
            ...
            for (const namedImport of namedImports) {
                ...
                const declaration = resolvedSourceFile.getVariableDeclaration(name) ||
                ...
                if (declaration != null) {
                    const initializer = 'getInitializer' in declaration
...
ImportsScanner = __decorate([
    Injectable()
], ImportsScanner);
export { ImportsScanner };
//# sourceMappingURL=imports.scanner.js.map